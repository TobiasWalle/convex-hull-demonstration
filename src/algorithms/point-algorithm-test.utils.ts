...
export async function expectPointAlgorithmToWorkWithSimpleExample(Alg: AbstractAlgorithmType<AbstractAlgorithm<Point>>): Promise<void> {
  const points = [
    { x: 1, y: 1 },
    { x: 0, y: 0 },
    { x: 2, y: 0 },
...
export async function expectPointAlgorithmToWorkWithIntermediateExample(Alg: AbstractAlgorithmType<AbstractAlgorithm<Point>>): Promise<void> {
  const points = [
    { x: 1, y: 1 },
    { x: 0, y: 0 },
    { x: 3, y: 1 },
...
export async function expectPointAlgorithmToWorkWithComplexExample(Alg: AbstractAlgorithmType<AbstractAlgorithm<Point>>): Promise<void> {
  const points = [
    {
      x: 611.4643860064564,
      y: 585.4202651770762
